...
**              Expected Idle Time (Ticks) before Sleep    : 100
**            Tick Rate (Hz)                               : 1000
**            Use 16bit ticks                              : no
...
**            User Heap Section                            : Enabled
**              Heap Section Name                          : .m_data_20000000
**            Total Heap Size                              : 16384
**          Shell                                          : Disabled
**          Utility                                        : UTIL
**     Contents    :
**         xTaskCreate                    - portBASE_TYPE FRTOS_xTaskCreate(pdTASK_CODE pvTaskCode, const portCHAR *...
**         vTaskStartScheduler            - void FRTOS_vTaskStartScheduler(void);
**         vTaskSuspend                   - void FRTOS_vTaskSuspend(xTaskHandle pxTaskToSuspend);
**         vTaskSuspendAll                - void FRTOS_vTaskSuspendAll(void);
**         vTaskResume                    - void FRTOS_vTaskResume(xTaskHandle pxTaskToResume);
**         xTaskResumeAll                 - portBASE_TYPE FRTOS_xTaskResumeAll(void);
**         xTaskResumeFromISR             - portBASE_TYPE FRTOS_xTaskResumeFromISR(xTaskHandle pxTaskToResume);
**         taskYIELD                      - void FRTOS_taskYIELD(void);
**         taskENTER_CRITICAL             - void FRTOS_taskENTER_CRITICAL(void);
**         taskEXIT_CRITICAL              - void FRTOS_taskEXIT_CRITICAL(void);
**         taskDISABLE_INTERRUPTS         - void FRTOS_taskDISABLE_INTERRUPTS(void);
**         taskENABLE_INTERRUPTS          - void FRTOS_taskENABLE_INTERRUPTS(void);
**         vTaskDelay                     - void FRTOS_vTaskDelay(portTickType xTicksToDelay);
**         vTaskDelayUntil                - void FRTOS_vTaskDelayUntil(portTickType *pxPreviousWakeTime, portTickType...
**         uxTaskPriorityGet              - unsigned_portBASE_TYPE FRTOS_uxTaskPriorityGet(xTaskHandle pxTask);
**         vTaskPrioritySet               - void FRTOS_vTaskPrioritySet(xTaskHandle pxTask, unsigned_portBASE_TYPE...
**         xTaskGetTickCount              - portTickType FRTOS_xTaskGetTickCount(void);
**         xTaskGetTickCountFromISR       - portTickType FRTOS_xTaskGetTickCountFromISR(void);
**         xSemaphoreCreateRecursiveMutex - xSemaphoreHandle FRTOS_xSemaphoreCreateRecursiveMutex(void);
**         xSemaphoreTakeRecursive        - bool FRTOS_xSemaphoreTakeRecursive(xSemaphoreHandle xMutex, portTickType...
**         xSemaphoreGiveRecursive        - bool FRTOS_xSemaphoreGiveRecursive(xSemaphoreHandle xMutex);
**         xSemaphoreCreateMutex          - xSemaphoreHandle FRTOS_xSemaphoreCreateMutex(void);
**         xSemaphoreTake                 - bool FRTOS_xSemaphoreTake(xSemaphoreHandle xMutex, portTickType xBlockTime);
**         xSemaphoreGive                 - bool FRTOS_xSemaphoreGive(xSemaphoreHandle xMutex);
**         vSemaphoreCreateBinary         - void FRTOS_vSemaphoreCreateBinary(xSemaphoreHandle xSemaphore);
**         xSemaphoreCreateCounting       - xSemaphoreHandle FRTOS_xSemaphoreCreateCounting(unsigned_portBASE_TYPE...
**         xSemaphoreGiveFromISR          - bool FRTOS_xSemaphoreGiveFromISR(xSemaphoreHandle xSemaphore,...
**         xSemaphoreTakeFromISR          - bool FRTOS_xSemaphoreTakeFromISR(xSemaphoreHandle xSemaphore,...
**         vSemaphoreDelete               - void FRTOS_vSemaphoreDelete(xSemaphoreHandle xSemaphore);
**         xSemaphoreGetMutexHolder       - void* FRTOS_xSemaphoreGetMutexHolder(xSemaphoreHandle xSemaphore);
**         pvPortMalloc                   - pVoid FRTOS_pvPortMalloc(size_t xWantedSize);
**         vPortFree                      - void FRTOS_vPortFree(void *pv);
**         xPortGetFreeHeapSize           - Tsize_t FRTOS_xPortGetFreeHeapSize(void);
**         xTaskGetSchedulerState         - portBASE_TYPE FRTOS_xTaskGetSchedulerState(void);
**         uxTaskGetStackHighWaterMark    - unsigned_portBASE_TYPE FRTOS_uxTaskGetStackHighWaterMark(xTaskHandle xTask);
**         uxTaskGetNumberOfTasks         - unsigned_portBASE_TYPE FRTOS_uxTaskGetNumberOfTasks(void);
**         uxQueueMessagesWaiting         - unsigned_portBASE_TYPE FRTOS_uxQueueMessagesWaiting(xQueueHandle xQueue);
**         uxQueueMessagesWaitingfromISR  - unsigned_portBASE_TYPE FRTOS_uxQueueMessagesWaitingfromISR(xQueueHandle xQueue);
**         xQueueCreate                   - xQueueHandle FRTOS_xQueueCreate(unsigned_portBASE_TYPE uxQueueLength,...
**         vQueueDelete                   - void FRTOS_vQueueDelete(xQueueHandle pxQueueToDelete);
**         xQueueReset                    - portBASE_TYPE FRTOS_xQueueReset(xQueueHandle xQueue);
**         xQueueSendToBack               - portBASE_TYPE FRTOS_xQueueSendToBack(xQueueHandle xQueue, const void...
**         xQueueSendToFront              - portBASE_TYPE FRTOS_xQueueSendToFront(xQueueHandle xQueue, const void...
**         xQueueReceive                  - portBASE_TYPE FRTOS_xQueueReceive(xQueueHandle xQueue, void *pvBuffer,...
**         xQueueOverwrite                - portBASE_TYPE FRTOS_xQueueOverwrite(xQueueHandle xQueue, const void...
**         xQueueOverwriteFromISR         - portBASE_TYPE FRTOS_xQueueOverwriteFromISR(xQueueHandle xQueue, const void...
**         xQueuePeek                     - portBASE_TYPE FRTOS_xQueuePeek(xQueueHandle xQueue, void *pvBuffer,...
**         xQueuePeekFromISR              - portBASE_TYPE FRTOS_xQueuePeekFromISR(xQueueHandle xQueue, void *pvBuffer,...
**         xQueueSendToBackFromISR        - portBASE_TYPE FRTOS_xQueueSendToBackFromISR(xQueueHandle xQueue, const void...
**         xQueueSendToFrontFromISR       - portBASE_TYPE FRTOS_xQueueSendToFrontFromISR(xQueueHandle xQueue, const void...
**         xQueueReceiveFromISR           - portBASE_TYPE FRTOS_xQueueReceiveFromISR(xQueueHandle xQueue, void *pvBuffer,...
**         vQueueAddToRegistry            - void FRTOS_vQueueAddToRegistry(xQueueHandle xQueue, char *pcQueueName);
**         vQueueUnregisterQueue          - void FRTOS_vQueueUnregisterQueue(xQueueHandle xQueue);
**         xQueueIsQueueFullFromISR       - portBASE_TYPE FRTOS_xQueueIsQueueFullFromISR(xQueueHandle xQueue);
**         xQueueIsQueueEmptyFromISR      - portBASE_TYPE FRTOS_xQueueIsQueueEmptyFromISR(xQueueHandle xQueue);
**         xEventGroupCreate              - EventGroupHandle_t FRTOS_xEventGroupCreate(void);
**         xEventGroupWaitBits            - byte FRTOS_xEventGroupWaitBits(const EventGroupHandle_t xEventGroup, const...
**         xEventGroupSetBits             - EventBits_t FRTOS_xEventGroupSetBits(EventGroupHandle_t xEventGroup, const...
**         xEventGroupSetBitsFromISR      - EventBits_t FRTOS_xEventGroupSetBitsFromISR(EventGroupHandle_t xEventGroup,...
**         xEventGroupClearBits           - EventBits_t FRTOS_xEventGroupClearBits(EventGroupHandle_t xEventGroup, const...
**         xEventGroupClearBitsFromISR    - EventBits_t FRTOS_xEventGroupClearBitsFromISR(EventGroupHandle_t xEventGroup,...
**         xEventGroupGetBits             - EventBits_t FRTOS_xEventGroupGetBits(EventGroupHandle_t xEventGroup);
**         xEventGroupGetBitsFromISR      - EventBits_t FRTOS_xEventGroupGetBitsFromISR(EventGroupHandle_t xEventGroup);
**         xEventGroupSync                - EventBits_t FRTOS_xEventGroupSync(EventGroupHandle_t xEventGroup, const...
**         Init                           - void FRTOS_Init(void);
**
...
*/         
/*!
**  @addtogroup FRTOS_module FRTOS module documentation
**  @{
*/         
...
/*
** ===================================================================
**     Method      :  FRTOS_xTaskCreate (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xTaskCreate(pdTASK_CODE pvTaskCode, const portCHAR * const pcName, unsigned portSHORT usStackDepth, void *pvParameters, unsigned portBASE_TYPE uxPriority, xTaskHandle *pvCreatedTask)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/

/*
** ===================================================================
**     Method      :  FRTOS_vTaskStartScheduler (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vTaskStartScheduler(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_taskYIELD (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  FRTOS_taskENTER_CRITICAL (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_taskENTER_CRITICAL(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_taskEXIT_CRITICAL (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_taskEXIT_CRITICAL(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_taskDISABLE_INTERRUPTS (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_taskDISABLE_INTERRUPTS(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_taskENABLE_INTERRUPTS (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_taskENABLE_INTERRUPTS(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vTaskSuspendAll (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vTaskSuspendAll(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xTaskResumeAll (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xTaskResumeAll(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xTaskResumeFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xTaskResumeFromISR(xTaskHandle pxTaskToResume)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vTaskDelay (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vTaskDelay(portTickType xTicksToDelay)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vTaskDelayUntil (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vTaskDelayUntil(portTickType *pxPreviousWakeTime, portTickType xTimeIncrement)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_uxTaskPriorityGet (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FRTOS_uxTaskPriorityGet(xTaskHandle pxTask)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vTaskPrioritySet (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vTaskPrioritySet(xTaskHandle pxTask, unsigned_portBASE_TYPE uxNewPriority)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xSemaphoreTakeRecursive (component FreeRTOS)
**     Description :
...
*/
/*
bool FRTOS_xSemaphoreTakeRecursive(xSemaphoreHandle xMutex, portTickType xBlockTime)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xSemaphoreGiveRecursive (component FreeRTOS)
**     Description :
...
*/
/*
bool FRTOS_xSemaphoreGiveRecursive(xSemaphoreHandle xMutex)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xSemaphoreCreateRecursiveMutex (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle FRTOS_xSemaphoreCreateRecursiveMutex(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vSemaphoreDelete (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vSemaphoreDelete(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vTaskSuspend (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vTaskSuspend(xTaskHandle pxTaskToSuspend)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vTaskResume (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vTaskResume(xTaskHandle pxTaskToResume)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xSemaphoreCreateMutex (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle FRTOS_xSemaphoreCreateMutex(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xSemaphoreTake (component FreeRTOS)
**     Description :
...
*/
/*
bool FRTOS_xSemaphoreTake(xSemaphoreHandle xMutex, portTickType xBlockTime)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xSemaphoreGive (component FreeRTOS)
**     Description :
...
*/
/*
bool FRTOS_xSemaphoreGive(xSemaphoreHandle xMutex)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vSemaphoreCreateBinary (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vSemaphoreCreateBinary(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xSemaphoreCreateCounting (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle FRTOS_xSemaphoreCreateCounting(unsigned_portBASE_TYPE uxMaxCount, unsigned_portBASE_TYPE uxInitialCount)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xSemaphoreGiveFromISR (component FreeRTOS)
**     Description :
**         Macro to release a semaphore. The semaphore must have
**         previously been created with a call to
...
*/
/*
bool FRTOS_xSemaphoreGiveFromISR(xSemaphoreHandle xSemaphore, signed_portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_pvPortMalloc (component FreeRTOS)
**     Description :
...
*/
/*
pVoid FRTOS_pvPortMalloc(size_t xWantedSize)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vPortFree (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  FRTOS_xTaskGetTickCount (component FreeRTOS)
**     Description :
...
*/
/*
portTickType FRTOS_xTaskGetTickCount(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xTaskGetSchedulerState (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xTaskGetSchedulerState(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_uxTaskGetStackHighWaterMark (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FRTOS_uxTaskGetStackHighWaterMark(xTaskHandle xTask)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_uxTaskGetNumberOfTasks (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FRTOS_uxTaskGetNumberOfTasks(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xPortGetFreeHeapSize (component FreeRTOS)
**     Description :
...
*/
/*
Tsize_t FRTOS_xPortGetFreeHeapSize(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueueCreate (component FreeRTOS)
**     Description :
**         Creates a queue.
**     Parameters  :
**         NAME            - DESCRIPTION
...
*/
/*
xQueueHandle FRTOS_xQueueCreate(unsigned_portBASE_TYPE uxQueueLength, unsigned_portBASE_TYPE uxItemSize)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueueSendToFront (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueueSendToFront(xQueueHandle xQueue, const void *pvItemToQueue, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueueSendToBack (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueueSendToBack(xQueueHandle xQueue, const void *pvItemToQueue, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueueReceive (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueueReceive(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueuePeek (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueuePeek(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vQueueDelete (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vQueueDelete(xQueueHandle pxQueueToDelete)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_uxQueueMessagesWaiting (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FRTOS_uxQueueMessagesWaiting(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_uxQueueMessagesWaitingfromISR (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FRTOS_uxQueueMessagesWaitingfromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueueReceiveFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueueReceiveFromISR(xQueueHandle xQueue, void *pvBuffer, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueueSendToFrontFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueueSendToFrontFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueueSendToBackFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueueSendToBackFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
/*
** ===================================================================
**     Method      :  FRTOS_xQueueReset (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueueReset(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xSemaphoreGetMutexHolder (component FreeRTOS)
**     Description :
...
*/
/*
void* FRTOS_xSemaphoreGetMutexHolder(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xSemaphoreTakeFromISR (component FreeRTOS)
**     Description :
...
*/
/*
bool FRTOS_xSemaphoreTakeFromISR(xSemaphoreHandle xSemaphore, signed_portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_Init (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  FRTOS_xTaskGetTickCountFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portTickType FRTOS_xTaskGetTickCountFromISR(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueuePeekFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueuePeekFromISR(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueueOverwrite (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueueOverwrite(xQueueHandle xQueue, const void *pvItemToQueue)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueueOverwriteFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueueOverwriteFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vQueueAddToRegistry (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vQueueAddToRegistry(xQueueHandle xQueue, char *pcQueueName)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_vQueueUnregisterQueue (component FreeRTOS)
**     Description :
...
*/
/*
void FRTOS_vQueueUnregisterQueue(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueueIsQueueFullFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueueIsQueueFullFromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xQueueIsQueueEmptyFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FRTOS_xQueueIsQueueEmptyFromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xEventGroupCreate (component FreeRTOS)
**     Description :
...
*/
/*
EventGroupHandle_t FRTOS_xEventGroupCreate(void)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xEventGroupWaitBits (component FreeRTOS)
**     Description :
...
*/
/*
byte FRTOS_xEventGroupWaitBits(const EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToWaitFor, const BaseType_t xClearOnExit, const BaseType_t xWaitForAllBits, TickType_t xTicksToWait)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xEventGroupSetBits (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FRTOS_xEventGroupSetBits(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xEventGroupSetBitsFromISR (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FRTOS_xEventGroupSetBitsFromISR(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet , BaseType_t *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xEventGroupClearBits (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FRTOS_xEventGroupClearBits(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xEventGroupClearBitsFromISR (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FRTOS_xEventGroupClearBitsFromISR(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xEventGroupGetBits (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FRTOS_xEventGroupGetBits(EventGroupHandle_t xEventGroup)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xEventGroupGetBitsFromISR (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FRTOS_xEventGroupGetBitsFromISR(EventGroupHandle_t xEventGroup)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
...
/*
** ===================================================================
**     Method      :  FRTOS_xEventGroupSync (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FRTOS_xEventGroupSync(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet, const EventBits_t uxBitsToWaitFor, TickType_t xTicksToWait)
{
  *** Implemented as macro in the header file FRTOS.h
}
*/
