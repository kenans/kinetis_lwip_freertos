...
/*-----------------------------------------------------------*/
#if configUSE_TICKLESS_IDLE == 1
void FRTOS_vOnPreSleepProcessing(TickType_t expectedIdleTicks); /* prototype */
...
__attribute__((weak)) void vPortSuppressTicksAndSleep(TickType_t xExpectedIdleTime) {
  ...
  if (eTaskConfirmSleepModeStatus()==eAbortSleep) {
    ...
    FRTOS_vOnPreSleepProcessing(xExpectedIdleTime); /* go into low power mode. Re-enable interrupts as needed! */
    /* ----------------------------------------------------------------------------
