...
#define FRTOS_PARSE_COMMAND_ENABLED  0 /* set to 1 if method ParseCommand() is present, 0 otherwise */
...
#define PEX_RTOS_START()               FRTOS_vTaskStartScheduler()
...
#define FRTOS_xTaskCreate(pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pvCreatedTask) \
...
#define FRTOS_vTaskStartScheduler() \
  vTaskStartScheduler()
/*
** ===================================================================
...
#define FRTOS_taskENTER_CRITICAL() \
  taskENTER_CRITICAL()
/*
** ===================================================================
...
#define FRTOS_taskEXIT_CRITICAL() \
  taskEXIT_CRITICAL()
/*
** ===================================================================
...
#define FRTOS_taskDISABLE_INTERRUPTS() \
...
#define FRTOS_taskENABLE_INTERRUPTS() \
...
#define FRTOS_vTaskDelay(xTicksToDelay) \
...
#define FRTOS_vTaskDelayUntil(pxPreviousWakeTime, xTimeIncrement) \
...
#define FRTOS_uxTaskPriorityGet(pxTask) \
...
#define FRTOS_vTaskPrioritySet(pxTask, uxNewPriority) \
...
#define FRTOS_xSemaphoreTakeRecursive(xMutex, xBlockTime) \
...
#define FRTOS_xSemaphoreGiveRecursive(xMutex) \
...
#define FRTOS_xSemaphoreCreateRecursiveMutex() \
  xSemaphoreCreateRecursiveMutex()
...
#define FRTOS_vTaskSuspend(pxTaskToSuspend) \
...
#define FRTOS_vTaskResume(pxTaskToResume) \
...
#define FRTOS_xSemaphoreCreateMutex() \
  xSemaphoreCreateMutex()
...
#define FRTOS_xSemaphoreTake(xMutex, xBlockTime) \
...
#define FRTOS_xSemaphoreGive(xMutex) \
...
#define FRTOS_vSemaphoreCreateBinary(xSemaphore) \
...
#define FRTOS_xSemaphoreCreateCounting(uxMaxCount, uxInitialCount) \
...
#define FRTOS_xSemaphoreGiveFromISR(xSemaphore, pxHigherPriorityTaskWoken) \
...
#define FRTOS_vSemaphoreDelete(xSemaphore) \
...
#define FRTOS_pvPortMalloc(xWantedSize) \
...
#define FRTOS_xTaskGetTickCount() \
  xTaskGetTickCount()
/*
** ===================================================================
...
#define FRTOS_xTaskGetSchedulerState() \
...
#define FRTOS_uxTaskGetStackHighWaterMark(xTask) \
...
#define FRTOS_uxTaskGetNumberOfTasks() \
...
#define FRTOS_xPortGetFreeHeapSize() \
...
#define FRTOS_xQueueCreate(uxQueueLength, uxItemSize) \
...
#define FRTOS_xQueueSendToFront(xQueue, pvItemToQueue, xTicksToWait) \
...
#define FRTOS_xQueueSendToBack(xQueue, pvItemToQueue, xTicksToWait) \
...
#define FRTOS_xQueueReceive(xQueue, pvBuffer, xTicksToWait) \
...
#define FRTOS_xQueuePeek(xQueue, pvBuffer, xTicksToWait) \
...
#define FRTOS_vQueueDelete(pxQueueToDelete) \
...
#define FRTOS_uxQueueMessagesWaiting(xQueue) \
...
#define FRTOS_uxQueueMessagesWaitingfromISR(xQueue) \
...
#define FRTOS_xQueueReceiveFromISR(xQueue, pvBuffer, pxHigherPriorityTaskWoken) \
...
#define FRTOS_xQueueSendToFrontFromISR(xQueue, pvItemToQueue, pxHigherPriorityTaskWoken) \
...
#define FRTOS_xQueueSendToBackFromISR(xQueue, pvItemToQueue,pxHigherPriorityTaskWoken) \
...
#define FRTOS_xTaskResumeFromISR(pxTaskToResume) \
...
#define FRTOS_xQueueReset(xQueue) \
  xQueueReset(xQueue)
...
#define FRTOS_xSemaphoreGetMutexHolder(xSemaphore) \
...
#define FRTOS_xSemaphoreTakeFromISR(xSemaphore, pxHigherPriorityTaskWoken) \
...
#define FRTOS_xTaskGetTickCountFromISR() \
...
#define FRTOS_xQueuePeekFromISR(xQueue, pvBuffer, xTicksToWait) \
...
#define FRTOS_xQueueOverwrite(xQueue, pvItemToQueue) \
...
#define FRTOS_xQueueOverwriteFromISR(xQueue, pvItemToQueue, pxHigherPriorityTaskWoken) \
...
#define FRTOS_vQueueAddToRegistry(xQueue, pcQueueName) \
...
#define FRTOS_vQueueUnregisterQueue(xQueue) \
...
#define FRTOS_xQueueIsQueueFullFromISR(xQueue) \
...
#define FRTOS_xQueueIsQueueEmptyFromISR(xQueue) \
...
#define FRTOS_xEventGroupCreate() \
  xEventGroupCreate()
/*
** ===================================================================
...
#define FRTOS_xEventGroupWaitBits(xEventGroup, uxBitsToWaitFor, xClearOnExit, xWaitForAllBits, xTicksToWait) \
...
#define FRTOS_xEventGroupSetBits(xEventGroup, uxBitsToSet) \
...
#define FRTOS_xEventGroupSetBitsFromISR(xEventGroup, uxBitsToSet, pxHigherPriorityTaskWoken) \
...
#define FRTOS_xEventGroupClearBits(xEventGroup, uxBitsToSet) \
...
#define FRTOS_xEventGroupClearBitsFromISR(xEventGroup, uxBitsToSet) \
...
#define FRTOS_xEventGroupGetBits(xEventGroup) \
...
#define FRTOS_xEventGroupGetBitsFromISR(xEventGroup) \
...
#define FRTOS_xEventGroupSync(xEventGroup, uxBitsToSet, uxBitsToWaitFor, xTicksToWait) \
