...
**     Date/Time   : 2014-06-19, 12:13, # CodeGen: 15
**     Abstract    :
...
{
  (void)FRTOS_xSemaphoreTakeRecursive(GI2C1_busSem, portMAX_DELAY);
}
...
{
  (void)FRTOS_xSemaphoreGiveRecursive(GI2C1_busSem);
}
...
void GI2C1_Init(void)
{
  ...
  GI2C1_busSem = FRTOS_xSemaphoreCreateRecursiveMutex();
...
void GI2C1_Deinit(void)
{
  ...
  FRTOS_vSemaphoreDelete(GI2C1_busSem);
}
